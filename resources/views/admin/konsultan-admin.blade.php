                ...
                <tr>
                    ...
                    <td>
                        @php
                            ...
                            $waMessage = "Halo {$data->nama_lengkap}, kami dari Wedding Organizer Diary Project ingin mengkonfirmasi Pertanyaan Anda dengan kami pada tanggal ".\Carbon\Carbon::parse($data->tanggal_acara)->format('d F Y').". Lokasi: {$data->alamat_lengkap}, terkait pertanyaan {$data->catatan}";
