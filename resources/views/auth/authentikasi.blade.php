...
<div class="container">
    ...
    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="card-body">
            <div class="pt-4 pb-3">
                <h5 class="card-title text-center pb-0 fs-4">Silahkan Masukan Akun</h5>
            </div>
            <form action="{{ route('auth.login') }}" method="POST" class="row g-3 needs-validation">
                ...
                <div class="col-12 d-flex justify-center ">
                    <p class="small mb-0">Belum punya Akun? <a href="{{ route('auth.show.logout') }}">Silahkan sign up</a></p>
                </div>
            </form>
            </div>
        </div>
